...
export class SettingsTab extends PluginSettingTab {
    ...
    constructor(app: App, plugin: SpeechAutoToJournal) {
        super(app, plugin);
        this.plugin = plugin;
    ...
    private createHeader(): void {
        this.containerEl.createEl("h2", { text: "Settings for SpeechAutoToJournal." });
    }
    ...
    private createSaveAudioFileToggleSetting(): void {
        new Setting(this.containerEl)
            ...
            .setDesc(
                "Turn on to save the audio file after sending it to the SpeechAutoToJournal API"
            )
            .addToggle((toggle) =>
                toggle
